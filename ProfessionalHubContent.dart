...
class ProfessionalHubContent extends StatefulWidget {
  final String? userId;

  ProfessionalHubContent({this.userId});

  @override
  State<ProfessionalHubContent> createState() => _ProfessionalHubContentState();
}

class _ProfessionalHubContentState extends State<ProfessionalHubContent> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      future: fetchUserDetails(widget.userId!),
                    ...
                    return Column(
                      children: [
                                      ...
                                      onTap: () {
                                        setState(() {
                                          ...
                                          _showVirtualWalletComingSoonBottomSheet(
                                              context); // Move this line here
                                        });
                                      },
                                      color: isSwahiliCardSelected
                                          ? null
                                          : Colors.green, // Add this line
                                    ),
                                  ),
                                ],
                              ),
                        ...
                        MyCardWidget(
                          ...
                          onTapEdit: () {
                            Navigator.pushNamed(context, '/addcontentUseredit');
                          },
                          context: context,
                        ),
                        const SizedBox(height: 30),
                                      ...
                                      child: Column(
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: const Text('Card Views',
                                                style: TextStyle(
                                                    fontSize: 12,
                                                    color: Colors.blueGrey)),
                                          ),
                                    ...
                                    return Container(
                                      ...
                                      child: Column(
                                        children: userContacts
                                          ...
                                          String companyNameWithoutRetrieve =
                                              companyName;
